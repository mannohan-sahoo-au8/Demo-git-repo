...
var loader = find(".loader"); // variables
...
function renderHTML(dbzCharacters) {
  var _iterator = _createForOfIteratorHelper(dbzCharacters),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var character = _step.value;
      var characterHTML = "<div data-name=".concat(character.name, " class=\"container__character container__character--1\">\n    <img\n      class=\"container__character-image\"\n      src=").concat(character.image, "\n      alt=\"Character\"\n    />\n    <p class=\"container__character-name\"><span>Name:</span> ").concat(character.name, "</p>\n    <p class=\"container__character-gender\"><span>Gender:</span> ").concat(character.gender, "</p>\n    <p class=\"container__character-planet\">\n      <span>Planet:</span> ").concat(character.planet, "\n    </p>\n  </div>");
...
function fetchDBZCharacters() {
  ...
  var dbzPromise = _axios.default.get("".concat(CORS_URL).concat(BASE_URL, "/api/character")).then(function (res) {
    var constructedData = [];
    var dbzCharacters = res.data;

    var _iterator2 = _createForOfIteratorHelper(dbzCharacters),
        _step2;
